  ...
  return (
    <div className="p-10">
      ...
      <form onSubmit={createPost} className="space-y-4">
        ...
        <div>
          <label className="block mb-1" htmlFor="content">일기</label>
        ...
        <button type="submit" className="mt-6 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">제출하기</button>
      </form>
    </div>
  )
} 